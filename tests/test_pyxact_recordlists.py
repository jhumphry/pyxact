...
def test_recordlist_metaclass():
    assert SimpleRecordList().record_type == SimpleRecord
...
def test_recordlist_values():
    ...
    assert rl1.values() == expected_values

    # In this case the sqlite3 does not require translation of values
    assert rl1.values_sql_repr(sqliteDialect) == expected_values
